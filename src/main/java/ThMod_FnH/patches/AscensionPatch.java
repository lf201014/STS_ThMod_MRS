...
public class AscensionPatch{
	...
	public static class CharSelectFix {
		...
		public static void Insert(CharacterOption _inst, AbstractPlayer.PlayerClass c, @ByRef Prefs[] pref){
			...
			if (pref[0] == null) {
				...
				if (pref[0] == null) {
					AscensionPatch.logger.info("AscensionPatch : CharSelectFix £ºpref == null?");
				} else {
